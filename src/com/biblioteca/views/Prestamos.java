...
public class Prestamos extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/lop.gif"))); // NOI18N

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/lop.gif"))); // NOI18N

        javax.swing.GroupLayout gifLayout = new javax.swing.GroupLayout(gif);
        gif.setLayout(gifLayout);
        gifLayout.setHorizontalGroup(
            gifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel7)
        );
        gifLayout.setVerticalGroup(
            gifLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel7)
        );
        ...
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 130, 200, 38));

        jLabel2.setFont(new java.awt.Font("Roboto", 0, 24)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Prestamos");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 80, 230, 50));

        jSeparator1.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 196, 20));

        jLabel3.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Fecha");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, 190, 38));

        jSeparator2.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 90, 196, 10));
        ...
        libroTxt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                libroTxtMousePressed(evt);
            }
        });
        jPanel1.add(libroTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, 196, 33));
        ...
        socioTxt.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                socioTxtMousePressed(evt);
            }
        });
        jPanel1.add(socioTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 60, 196, 33));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/My project-4.png"))); // NOI18N
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, 240, 210));
        ...
        jPanel1.add(prestamoB, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 220, 200, 50));

        jLabel4.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Socio");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 190, 38));

        jSeparator3.setForeground(new java.awt.Color(0, 0, 0));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 90, 200, 10));
        ...
        jPanel1.add(fechaTxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 60, 196, 33));

        contenido.setBackground(new java.awt.Color(255, 255, 255));
        contenido.setMinimumSize(new java.awt.Dimension(200, 150));
        contenido.setPreferredSize(new java.awt.Dimension(200, 150));
        ...
        jPanel1.add(contenido, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, 180, 160));
    ...
    private void socioTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_socioTxtMousePressed
        if(socioTxt.getText().equals("Ingrese su numero de socio")){
            socioTxt.setText("");
            socioTxt.setForeground(Color.black);
        }
    ...
    }//GEN-LAST:event_socioTxtMousePressed

    private void libroTxtMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_libroTxtMousePressed
        if(libroTxt.getText().equals("Ingrese el codigo del libro")){
            libroTxt.setText("");
            libroTxt.setForeground(Color.black);
        }
    ...
    }//GEN-LAST:event_libroTxtMousePressed
    ...
    private void prestamoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_prestamoMouseClicked
        ...
        try{                                      
            ...
            String fecha = fechaTxt.getText();
                ...
                this.biblioteca.prestarLibro(libro, socio, fecha);
